namespace MyCarsDb.Server.WebApi.Auth
{
    ...
    public class MyCarsDbUserManager : UserManager<User, int>
    {
        ...
        public static MyCarsDbUserManager Create(IdentityFactoryOptions<MyCarsDbContext> options, IOwinContext context)
        {
            MyCarsDbContext dbContext = context.Get<MyCarsDbContext>();
            var userStore = new UserStore<User, Role, int, IdentityUserLogin<int>, IdentityUserRole<int>, IdentityUserClaim<int>>(dbContext);
